...
function EditUserProfile() {
  ...
  // -------- Premium  --------
  const premiumGold =
    theme?.colors?.premium?.gold ?? (DARK ? "#FFD700" : "#7A5F00");
  const premiumBgBase =
    theme?.colors?.premium?.bg ?? (DARK ? "#1E3A8A" : "#A0BDE8");
  const premiumBg = hexToRGBA(premiumBgBase, DARK ? 0.35 : 0.22);
    ...
    <div className="mx-auto space-y-6">
      ...
      >
        ...
        <div
          ...
          style={{ borderColor: DIVIDER, borderBottomWidth: DIVIDER_W }}
        >
              ...
              <div className="mt-2">
                <span
                  ...
                  style={{
                    ...
                    color: isPremium ? premiumGold : theme.colors.primary.main,
                    border: `1px solid ${hexToRGBA(premiumGold, DARK ? 0.35 : 0.45)}`,
                  }}
                >
                  <Shield className="h-4 w-4 mr-1" style={{ color: isPremium ? premiumGold : theme.colors.primary.main }} />
